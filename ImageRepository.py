...
def Bundle(num_of_tier1_suppliers=1, num_of_targets_per_tier1_supplier=1):
  ...
  supplierMetadata = TargetsModule.\
  ...
  bundle = (num_of_tier1_suppliers * supplierMetadata) + \
           targetsMetadata + snapshotMetadata + timestampMetadata
